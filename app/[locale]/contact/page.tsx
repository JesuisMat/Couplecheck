  ...
  fr: {
    ...
    body: (
      <>
        ...
        <p><a href="mailto:hello@couplecheck.fr">hello@couplecheck.fr</a></p>

        <h2>Données personnelles & RGPD</h2>
        <p>Pour exercer vos droits (accès, rectification, suppression) ou toute question relative à vos données personnelles :</p>
        <p><a href="mailto:privacy@couplecheck.fr">privacy@couplecheck.fr</a></p>
        ...
        <h2>Remboursement</h2>
        <p>Vous avez acheté un rapport et n'êtes pas satisfait ? Écrivez-nous à <a href="mailto:hello@couplecheck.fr">hello@couplecheck.fr</a> dans les 7 jours suivant l'achat en précisant votre numéro de commande. Nous examinerons votre demande au cas par cas.</p>
      </>
    ),
  },
  en: {
    ...
    body: (
      <>
        ...
        <h2>Refunds</h2>
        <p>Purchased a report and not satisfied? Email us at <a href="mailto:hello@couplecheck.fr">hello@couplecheck.fr</a> within 7 days of purchase, including your order number. We review each case individually.</p>
      </>
    ),
  },
};
